...
static constexpr const char *bg_col_table[Renderer::TRANSPARENT + 1] = {
    COLOR_BLACK,   COLOR_RED,  COLOR_GREEN, COLOR_YELLOW, COLOR_BLUE,
    COLOR_MAGENTA, COLOR_CYAN, COLOR_WHITE, COLOR_DEFAULT};

static constexpr const char *fg_col_table[Renderer::TRANSPARENT + 1] = {
    TEXT_COL_BLACK,  TEXT_COL_RED,   TEXT_COL_GREEN,
    TEXT_COL_YELLOW, TEXT_COL_BLUE,  TEXT_COL_MAGENTA,
    TEXT_COL_CYAN,   TEXT_COL_WHITE, TEXT_COL_DEFAULT};
