...
Vector2I::Vector2I(const Vector2 &p_other) : x(p_other.x), y(p_other.y) {}
...
Vector2I Vector2I::operator/(const Vector2I &p_other) const {
  return {p_other.x == 0 ? x : x / p_other.x,
...
double Vector2I::length() const { return std::hypot(x, y); }
...
Vector2::Vector2(const Vector2I &p_other) : x(p_other.x), y(p_other.y) {}
...
double Vector2::length() const { return std::hypot(x, y); }
